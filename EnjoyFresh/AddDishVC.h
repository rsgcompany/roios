...
@interface AddDishVC : UIViewController<MBProgressHUDDelegate>{
...
@property (strong, nonatomic) IBOutlet UIButton *cancelDButton;
@property (strong, nonatomic) IBOutlet UIButton *doneDButton;
